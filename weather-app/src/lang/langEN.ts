...
export const langEN:ILang = {
    ...
    INFOTEXT: "Example application for weather forecast based on a free API from openweathermap.org. For viewing weather information, just type a city in the searchbox at the top.",
